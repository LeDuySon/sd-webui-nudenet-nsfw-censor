...
censor_region_settings = {
    ...
    'nudenet_nsfw_censor_enable': shared.OptionInfo(False, 'Enable Region censor for image generation').info('default True'),
    'nudenet_nsfw_censor_save_before_censor': shared.OptionInfo(False, 'Save a copy of the image before applying censor').info('default True'),
